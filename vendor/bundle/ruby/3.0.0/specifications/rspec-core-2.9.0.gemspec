# -*- encoding: utf-8 -*-
# stub: rspec-core 2.9.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-core-2.9.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<fakefs>.freeze, ["= 0.4.0"])
    ...
    s.add_dependency(%q<fakefs>.freeze, ["= 0.4.0"])
